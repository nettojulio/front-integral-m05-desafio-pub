        ...
        <div className="resume-bills-card-bills">
          {
            cardBillsValue.map(cardValue => (
              <CardBills key={Math.random()} bgColor={cardValue.bgColor} title={cardValue.title} img={cardValue.img} value={cardValue.value} />
            ))
          }
        </div>
        ...
        <div className="table-cards">
          {
            cardTableValue.map(cardTable => (
              <TableCard key={Math.random()} title={cardTable.title} bgColor={cardTable.bgColor} />
            ))
          }
        </div>
        <div className="table-cards-clients">
          {
            cardTableClientsValue.map(cardClients => (
              <TableCardClients key={Math.random()} title={cardClients.title} icon={cardClients.icon} bgColor={cardClients.bgColor} />
            ))
          }
        </div>
      </div>
