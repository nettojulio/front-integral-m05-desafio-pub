          ...
          <form className="editChargeForm" onSubmit={handleSubmit}>
            <div className="chargeFormGroup">
              <label htmlFor="nome" className="chargeFormLabels">
                ...
                <input
                  ...
                  value={openChargeModal.nome}
                  onChange={(e) => handleChange(e.target)}
                  className={`inputCharge ${
                    nameErrorMessage ? "chargeErrorSinalization" : undefined
                  }`}
                />
                {nameErrorMessage && (
            ...
            <div className="chargeFormGroup descricao">
              <label htmlFor="descricao" className="chargeFormLabels">
                ...
                <input
                  ...
                  onChange={(e) => handleChange(e.target)}
                  className={`inputCharge ${
                    emailErrorMessage ? "chargeErrorSinalization" : undefined
                  }
                  `}
                />
                {emailErrorMessage && (
            ...
            <div className="chargeFormGroup top">
              ...
              >
                ...
                <InputMask
                  ...
                  mask="99-99-9999"
                  className={`inputCharge ${
                    cpfErrorMessage ? "chargeErrorSinalization" : undefined
                  }`}
                />
                {cpfErrorMessage && (
            ...
            <div className="chargeFormGroup">
              <label htmlFor="status" className="chargeFormLabels">
                ...
                <div className="status">
                  <img
                    onClick={handleCheckExpected}
                    src={checkExpected ? confirmRadio : emptyRadio}
                    alt=""
                  />
